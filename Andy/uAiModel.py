...
class uAiModel(object):
    ...
    def createSimpleModel(X_train, X_test, y_train, y_test, batch_size = 128, epochs = 20, auc_at_epoch_nb = None):
        ...
        print("------------------------------------------------------------------")
        print("Training with Neural Network model: D256 Drop20 D128 D32 D4 D1")
        model = Sequential([Dense(256 , input_shape=(Xcols,)), Activation('relu'),
                            Dropout(rate=0.20),
    ...
    def createArrayModels(X_train, X_test, y_train, y_test, batch_size = 128, epochs = 20):
        ...
        # models.append(("D512 D128 D32 D4 Drop10 D1", [Dense(512 , input_shape=(Xcols,)), Activation('relu'), Dense(128,input_shape=(Xcols,)), Activation('relu'), Dense(32 , input_shape=(Xcols,)), Activation('relu'), Dropout(rate=0.10), Dense(4, input_shape=(Xcols,)), Activation('relu'), Dense(1), Activation('sigmoid')]))
        # models.append(("D512 D128 D32 D4 Drop20 D1", [Dense(512 , input_shape=(Xcols,)), Activation('relu'), Dense(128,input_shape=(Xcols,)), Activation('relu'), Dense(32 , input_shape=(Xcols,)), Activation('relu'), Dropout(rate=0.20), Dense(4, input_shape=(Xcols,)), Activation('relu'), Dense(1), Activation('sigmoid')]))
        # models.append(("D512 D128 D32 D4 Drop30 D1", [Dense(512 , input_shape=(Xcols,)), Activation('relu'), Dense(128,input_shape=(Xcols,)), Activation('relu'), Dense(32 , input_shape=(Xcols,)), Activation('relu'), Dropout(rate=0.30), Dense(4, input_shape=(Xcols,)), Activation('relu'), Dense(1), Activation('sigmoid')]))
        models.append(("D512 D128 D32 D4 Drop40 D1", [Dense(512 , input_shape=(Xcols,)), Activation('relu'), Dense(128,input_shape=(Xcols,)), Activation('relu'), Dense(32 , input_shape=(Xcols,)), Activation('relu'), Dropout(rate=0.40), Dense(4, input_shape=(Xcols,)), Activation('relu'), Dense(1), Activation('sigmoid')]))
        models.append(("D512 D128 D32 D4 Drop50 D1", [Dense(512 , input_shape=(Xcols,)), Activation('relu'), Dense(128,input_shape=(Xcols,)), Activation('relu'), Dense(32 , input_shape=(Xcols,)), Activation('relu'), Dropout(rate=0.50), Dense(4, input_shape=(Xcols,)), Activation('relu'), Dense(1), Activation('sigmoid')]))
        models.append(("D512 D128 D32 D4 Drop60 D1", [Dense(512 , input_shape=(Xcols,)), Activation('relu'), Dense(128,input_shape=(Xcols,)), Activation('relu'), Dense(32 , input_shape=(Xcols,)), Activation('relu'), Dropout(rate=0.60), Dense(4, input_shape=(Xcols,)), Activation('relu'), Dense(1), Activation('sigmoid')]))
        
        # models.append(("D512 MaxP1-1 D128 D32 D4 Drop20 D1", [Dense(512 , input_shape=(Xcols,)), Activation('relu'), MaxPooling1D(pool_size=1, strides=1), Dense(128,input_shape=(Xcols,)), Activation('relu'), Dense(32 , input_shape=(Xcols,)), Activation('relu'), Dropout(rate=0.20), Dense(4, input_shape=(Xcols,)), Activation('relu'), Dense(1), Activation('sigmoid')]))
        # models.append(("D512 MaxP1-2 D128 D32 D4 Drop20 D1", [Dense(512 , input_shape=(Xcols,)), Activation('relu'), MaxPooling1D(pool_size=1, strides=2), Dense(128,input_shape=(Xcols,)), Activation('relu'), Dense(32 , input_shape=(Xcols,)), Activation('relu'), Dropout(rate=0.20), Dense(4, input_shape=(Xcols,)), Activation('relu'), Dense(1), Activation('sigmoid')]))
        # models.append(("D512 MaxP2-1 D128 D32 D4 Drop20 D1", [Dense(512 , input_shape=(Xcols,)), Activation('relu'), MaxPooling1D(pool_size=2, strides=1), Dense(128,input_shape=(Xcols,)), Activation('relu'), Dense(32 , input_shape=(Xcols,)), Activation('relu'), Dropout(rate=0.20), Dense(4, input_shape=(Xcols,)), Activation('relu'), Dense(1), Activation('sigmoid')]))
        # models.append(("D512 MaxP2-2 D128 D32 D4 Drop20 D1", [Dense(512 , input_shape=(Xcols,), output_dim=1), Activation('relu'), MaxPooling1D(pool_size=2, strides=1), Dense(128,input_shape=(Xcols,)), Activation('relu'), Dense(32 , input_shape=(Xcols,)), Activation('relu'), Dropout(rate=0.20), Dense(4, input_shape=(Xcols,)), Activation('relu'), Dense(1), Activation('sigmoid')]))
        
        # models.append(("D512 MaxP1-1 D128 MaxP1-1 D32 D4 Drop10 D1", [Dense(512 , input_shape=(Xcols,)), Activation('relu'), MaxPooling1D(pool_size=1, strides=1), Dense(128,input_shape=(Xcols,)), Activation('relu'), MaxPooling1D(pool_size=1, strides=1), Dense(32 , input_shape=(Xcols,)), Activation('relu'), Dropout(rate=0.10), Dense(4, input_shape=(Xcols,)), Activation('relu'), Dense(1), Activation('sigmoid')]))
        # models.append(("D512 MaxP1-2 D128 MaxP1-2 D32 D4 Drop20 D1", [Dense(512 , input_shape=(Xcols,)), Activation('relu'), MaxPooling1D(pool_size=1, strides=2), Dense(128,input_shape=(Xcols,)), Activation('relu'), MaxPooling1D(pool_size=1, strides=2), Dense(32 , input_shape=(Xcols,)), Activation('relu'), Dropout(rate=0.20), Dense(4, input_shape=(Xcols,)), Activation('relu'), Dense(1), Activation('sigmoid')]))
